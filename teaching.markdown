...
If you are a student, I supervise projects (BSc and MSc level) on storage system performance characterizations and optimizations.  For further reading and examples, students have completed the following projects succesfully with me as a daily supervisor at Vrije Universiteit Amsterdam:
<ul>
    <li> [MSc research project] Duc Anh Phan — <i> I/O Characterization Study of Prefix caching in vLLM </i> — <a href="{{ site.url }}/downloads/???.pdf" style="color:#009988">PDF</a> <a href="https://github.com/t348575/???" style="color:#009988">Code</a> — 2025 </li>
