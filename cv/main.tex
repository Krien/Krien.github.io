...
\begin{center}
    ...
    \textit{ Computer Science PhD candidate, characterizing and improving performance QoS of NVMe storage. } 
\end{center}
...
\section{Employment}
  \resumeSubHeadingListStart
    \resumeSubheading
      {PhD in Computer Science}{Dec. 2022 -- Apr. 2026, Aug. 2026 --}
      ...
      %}
      \resumeItem{
        Job: Computer systems research and teaching, specializing in characterizing and optimizing performance QoS of NVMe storage (Linux, C, C++, Python, NVMe, NVMe ZNS)
      }
      \resumeItemListEnd

     \resumeSubheading
      {Technical intern (PhD)}{May. 2026 -- Aug. 2026}
      {WD}{Copenhagen, Denmark}
      \resumeItemListStart
      \resumeItem{
        Job: computer systems R\&D for LLM inference 
      }
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{ 
          Job: Setting up the analytics pipeline, telemetry tooling and A/B test tooling
        }
        \resumeItem{
...
\item
  ...
  J.S. Kanichai, \underline{K. Doekemeijer},  S. van der Vlugt, D. Niewenhuis, T. De Matteis, A.Trivedi, 
  \textit{In 2026 IEEE International Symposium on Workload Characterization (IISWC)}, 
  ??, 2026.
...
\section{Research Projects}
    ...
    \resumeProjectHeading
      {\textbf{isol-bench} $|$ \emph{NVMe SSDs, benchmark}} {January 2025 -- December 2025}
      \resumeItemListStart
        \resumeItem{isol-bench is a benchmark to evaluate performance isolation of NVMe storage.
        See: \href{https://github.com/stonet-research/isol-bench}{\underline{https://github.com/stonet-research/isol-bench}}.   }
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{ConfZNS++} $|$ \emph{ZNS SSDs, emulator}} {April 2024 -- December 2025}
      \resumeItemListStart
      ...
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{ZINC} $|$ \emph{ZNS SSDs, I/O scheduler, kernel modules}} {Oktober 2023 -- December 2025}
      \resumeItemListStart
      ...
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{ZWAL} $|$ \emph{ZNS SSDs, KV-store, WAL}} {July 2023 -- December 2025}
      \resumeItemListStart
      ...
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{zns-tools} $|$ \emph{ZNS SSDs, tracing, profiling, end-to-end, BPF}} {March 2023 -- December 2025}
      \resumeItemListStart
      ...
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{TropoDB} $|$ \emph{ZNS SSDs, Key-value store, SPDK, raw storage}} {February 2022 -- August 2024}
      \resumeItemListStart
      ...
      \resumeItemListEnd
    \resumeProjectHeading
      {\textbf{Simple ZNS Device (SZD)} $|$ \emph{ZNS SSDs, SPDK, io\_uring, API}} {February 2022 -- December 2025}
      \resumeItemListStart
...
\section{Talks}
    ...
    \item
        ``Does Linux Provide Performance Isolation for NVMe SSDs? Configuring cgroups for I/O Control in the NVMe Era'',
        \textit{IISWC'25}, October, 2025, Irvine, CA, USA.
    \item
        ``Exploring I/O Management Performance in ZNS with ConfZNS++'',
...
\begin{itemize}[label={}]
\itemsep0em
  \item Paper: \textit{ACM Transactions on Storage (TOS)}, 2025
  
  \item Paper: \textit{ACM/IFIP International Middleware Conference (Middleware)}, 2025
  
  \item Paper: \textit{ACM/SPEC International Conference on Performance Engineering (ICPE)}, 2024
  
  \item Paper: \textit{IEEE/ACM International Symposium on Cluster, Cloud and Internet Computing (CCGrid)}, 2024
   
  \item Paper: \textit{ACM International Symposium on High-Performance Parallel and Distributed Computing (HPDC)}, 2023

  \item Artifact: \textit{Symposium on Operating Systems Principles (SOSP)}, 2023
\end{itemize}
...
\begin{itemize}[label={}]
\itemsep0em
  \item Duc Anh Phan (MSc. research project, 2025) -- Daily supervisor\\  
  \textit{LLM KV Cache Performance Characterization When Using Disk Offloading for Prefix Caching}.

  \item Joseph Kanichai  (MSc. thesis, 2025) -- Daily supervisor\\  
  \textit{Characterizing The Energy Contribution and Energy-Performance Trade-offs of NVMe SSDs in the Linux Storage Stack}.

  \item Yigit Abaci  (BSc. thesis, 2025) -- Daily supervisor\\  
  \textit{A Performance Analysis of TC for High Speed, Scalable Data Center Networks}.

  \item Gleb Mishchenko  (BSc. honours program, 2025) -- Daily supervisor\\
  \textit{You do not need fast NVMes for MVEs. PokeSto: A Storage Benchmark for Modifiable Virtual Environments}.
  
  \item Sudarsan Sivakumar (MSc. thesis, 2024) -- Daily supervisor\\ 
  \textit{Performance Characterization Study of NVMe Storage Over TCP}.
  
  \item Darko Vujica (BSc. thesis, 2024) -- Daily supervisor\\ 
  \textit{Exploring Redis Persistence Modes: Introducing AOFURing, an io\_uring AOF Extension}.
  
  \item Vincent Kohm (BSc. thesis, 2024) -- Daily supervisor\\ 
  \textit{Optimizing Metadata Handling with vkFS: A Hybrid Key-Value Store File System leveraging RocksDB}.
  
  \item Sudarsan Sivakumar (MSc. survey, 2024) -- Daily supervisor\\ 
  \textit{A survey on flash storage disaggregation: performance and quality of service considerations}.
\end{itemize}
