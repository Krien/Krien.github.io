...
\section{Employment}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Doctor of Philosophy in Computer Science}{Dec. 2022 -- Jan. 2026}
      ...
      \resumeItem{
        Research focus: Computer systems, specializing in characterizing and optimizing performance QoS of NVMe storage (Linux, C, C++, Python, NVMe, NVMe ZNS)
      }
      \resumeItemListEnd
    \resumeSubheading
