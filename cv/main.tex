...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Analytics pipeline, Telemetry tooling, A/B test tooling}
        \resumeItem{DevOps tasks like AWS and CI/CD tasks}
        \resumeItem{Machine learning (genetic algorithms)}
        \resumeItem{Backend and Frontend (web development)}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{Developing a serious game in C\# and \textit{MonoGame} (game library) in a well-rounded team of 10 students}
            \resumeItem{Helped designing a graphical/logical simulation of the Dutch train network}
            \resumeItem{Created the UI framework for Derailed from the ground up using only Monogame}
            \resumeItem{Responsible for the software architecture and its design (also involves skills such as UML)}
      \resumeItemListEnd
